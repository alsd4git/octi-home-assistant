...
- **Done:** Set Home Assistant `2026.2.3` / Python 3.13 as the minimum tested baseline and add Home Assistant `2026.9.1` / Python 3.14 to the CI matrix.
...
- **Done:** Add the validation workflow; Hassfest, Ruff, Home Assistant tests and fixture verification pass locally. CI tests both Home Assistant 2026.2.3 and 2026.9.1; HACS validation runs with the repository context in GitHub Actions.
